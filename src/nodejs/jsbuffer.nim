...
func byteLength*(self: Buffer; encoding = "utf8".cstring): int {.importjs: "(Buffer.$1(#) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_static_method_buffer_bytelength_string_encoding

func compare*(self: Buffer; other: Buffer): int {.importjs: "(Buffer.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_static_method_buffer_compare_buf1_buf2

func compare*(self: Buffer; other: Buffer; targetStart, targetEnd, sourceStart, sourceEnd: int): int {.importjs: "(#.$1(#, #, #, #, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_compare_target_targetstart_targetend_sourcestart_sourceend

func compare*(self: Buffer; other: Buffer; targetStart, sourceStart, sourceEnd: int): int {.importjs: "(#.$1(#, #, #, #) || 0)".}
...
func isBuffer*(objec: JsObject): bool {.importjs: "(Buffer.$1(#) || false)".}
  ## https://nodejs.org/api/buffer.html#buffer_static_method_buffer_concat_list_totallength

func isEncoding*(encoding: cstring): bool {.importjs: "(Buffer.$1(#) || false)".}
...
func `==`*(self: Buffer; other: Buffer): bool {.importjs: "(#.equals(#) || false)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_equals_otherbuffer

func contains*(self: Buffer; value: cstring or Buffer or int; byteOffset = 0; encoding = "utf8".cstring): bool {.importjs: "(#.$1(#, #, #) || false)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_includes_value_byteoffset_encoding

func find*(self: Buffer; value: cstring or Buffer or int; byteOffset = 0; encoding = "utf8".cstring): int {.importjs: "(#.indexOf(#, #, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_indexof_value_byteoffset_encoding

func lastIndexOf*(self: Buffer; value: cstring or Buffer or int; byteOffset = 0; encoding = "utf8".cstring): int {.importjs: "(#.$1(#, #, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_lastindexof_value_byteoffset_encoding

func readBigInt64BE*(self: Buffer; offset = 0): JsBigInt {.importjs: "(#.$1(#) || 0n)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readbigint64be_offset

func readBigInt64LE*(self: Buffer; offset = 0): JsBigInt {.importjs: "(#.$1(#) || 0n)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readbigint64le_offset

func readBigUInt64BE*(self: Buffer; offset = 0): JsBigInt {.importjs: "(#.$1(#) || 0n)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readbiguint64be_offset

func readBigUInt64LE*(self: Buffer; offset = 0): JsBigInt {.importjs: "(#.$1(#) || 0n)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readbiguint64le_offset

func readDoubleBE*(self: Buffer; offset = 0): BiggestFloat {.importjs: "(#.$1(#) || 0.0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readdoublebe_offset

func readDoubleLE*(self: Buffer; offset = 0): BiggestFloat {.importjs: "(#.$1(#) || 0.0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readdoublele_offset

func readFloatBE*(self: Buffer; offset = 0): float32 {.importjs: "(#.$1(#) || 0.0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readdoublele_offset

func readFloatLE*(self: Buffer; offset = 0): float32 {.importjs: "(#.$1(#) || 0.0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readfloatle_offset

func readInt8*(self: Buffer; offset = 0): int8 {.importjs: "(#.$1(#) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readint8_offset

func readInt16BE*(self: Buffer; offset = 0): int16 {.importjs: "(#.$1(#) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readint16be_offset

func readInt16LE*(self: Buffer; offset = 0): int16 {.importjs: "(#.$1(#) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readint16le_offset

func readInt32BE*(self: Buffer; offset = 0): int32 {.importjs: "(#.$1(#) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readint32be_offset

func readInt32LE*(self: Buffer; offset = 0): int32 {.importjs: "(#.$1(#) || 0)".}
...
func readUInt8*(self: Buffer; offset = 0): uint8 {.importjs: "(#.$1(#) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readuint8_offset

func readUInt16BE*(self: Buffer; offset = 0): uint16 {.importjs: "(#.$1(#) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readuint16be_offset

func readUInt16LE*(self: Buffer; offset = 0): uint16 {.importjs: "(#.$1(#) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readuint16le_offset

func readUInt32BE*(self: Buffer; offset = 0): uint32 {.importjs: "(#.$1(#) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_readuint32be_offset

func readUInt32LE*(self: Buffer; offset = 0): uint32 {.importjs: "(#.$1(#) || 0)".}
...
func write*(self: Buffer; str: cstring; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_write_string_offset_length_encoding

func writeBigInt64BE*(self: Buffer; value: JsBigInt; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writebigint64be_value_offset

func writeBigInt64LE*(self: Buffer; value: JsBigInt; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writebigint64le_value_offset

func writeBigUInt64BE*(self: Buffer; value: JsBigInt; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writebiguint64be_value_offset

func writeBigUInt64LE*(self: Buffer; value: JsBigInt; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writebiguint64le_value_offset

func writeDoubleBE*(self: Buffer; value: BiggestFloat; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writedoublebe_value_offset

func writeDoubleLE*(self: Buffer; value: BiggestFloat; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writedoublele_value_offset

func writeFloatBE*(self: Buffer; value: float; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writefloatbe_value_offset

func writeFloatLE*(self: Buffer; value: float; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writefloatle_value_offset

func writeInt8*(self: Buffer; value: int8; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeint8_value_offset

func writeInt16BE*(self: Buffer; value: int16; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeint16be_value_offset

func writeInt16LE*(self: Buffer; value: int16; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeint16le_value_offset

func writeInt32BE*(self: Buffer; value: int32; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeint32be_value_offset

func writeInt32LE*(self: Buffer; value: int32; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeint32le_value_offset

func writeIntBE*(self: Buffer; value: int; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeintbe_value_offset_bytelength

func writeIntLE*(self: Buffer; value: int; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeintle_value_offset_bytelength

func writeUInt8*(self: Buffer; value: uint8; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeuint8_value_offset

func writeUInt16BE*(self: Buffer; value: uint16; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeuint16be_value_offset

func writeUInt16LE*(self: Buffer; value: uint16; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeuint16be_value_offset

func writeUInt32BE*(self: Buffer; value: uint32; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeuint16be_value_offset

func writeUInt32LE*(self: Buffer; value: uint32; offset = 0): int {.importjs: "(#.$1(#, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeuint32le_value_offset

func writeUIntBE*(self: Buffer; value: SomeUnsignedInt; offset: int; byteLength: int): int {.importjs: "(#.$1(#, #, #) || 0)".}
  ## https://nodejs.org/api/buffer.html#buffer_buf_writeuintbe_value_offset_bytelength

func writeUIntLE*(self: Buffer; value: SomeUnsignedInt; offset: int; byteLength: int): int {.importjs: "(#.$1(#, #, #) || 0)".}
