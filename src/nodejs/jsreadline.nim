## .. warning:: You MUST import `process` before importing this module.
...
func clearLine*(s = "process.stout".cstring; dir = 0.cint): bool {.importjs: "readline.$1(#, #)".}
  ## https://nodejs.org/docs/latest/api/readline.html#readline_readline_clearline_stream_dir_callback

func clearScreenDown*(s = "process.stout".cstring): bool {.importjs: "readline.$1(#)".}
  ## https://nodejs.org/docs/latest/api/readline.html#readline_readline_clearscreendown_stream_callback

func cursorTo*(s = "process.stout".cstring; x = 0.cint; y = 0.cint): bool {.importjs: "readline.$1(#, #, #)".}
  ## https://nodejs.org/docs/latest/api/readline.html#readline_readline_cursorto_stream_x_y_callback

func moveCursor*(s = "process.stout".cstring; dx = 0.cint; dy = 0.cint): bool {.importjs: "readline.$1(#, #, #)".}
