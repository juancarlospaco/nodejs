...
func access*(path: cstring; mode: cint; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_access_path_mode_callback

func accessSync*(path: cstring; mode: cint) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_accesssync_path_mode

func appendFile*(path, data: cstring; callback: proc) {.importjs: "fs.$1(#, #, #)".}
...
func chmod*(path: cstring; mode: cstring; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_chmod_path_mode_callback

func chmod*(path: cstring; mode: cint; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_chmod_path_mode_callback
...
func chown*(path: cstring; uid: cint; gid: cint; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
...
func close*(fd: cint; callback: proc) {.importjs: "fs.$1(#, #)".}
...
func copyFile*(src, dest: cstring; mode: cint; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_copyfile_src_dest_mode_callback

func copyFile*(src, dest: cstring; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_copyfile_src_dest_mode_callback
...
func fchmod*(fd: cint; mode: cstring; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_fchmod_fd_mode_callback

func fchmod*(fd: cint; mode: cint; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_fchmod_fd_mode_callback
...
func fchown*(fd, uid, gid: cint; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
...
func fdatasync*(fd: cint; callback: proc) {.importjs: "fs.$1(#, #)".}
...
func fstat*(fd: cint; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_fstat_fd_options_callback

func fsync*(fd: cint; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_fsync_fd_callback

func ftruncate*(fd: cint; len: cint; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_ftruncate_fd_len_callback

func ftruncate*(fd: cint; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_ftruncate_fd_len_callback

func ftruncateSync*(fd: cint; len: cint) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_ftruncatesync_fd_len

func futimes*(fd: cint; atime: cint; mtime: cint; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_futimes_fd_atime_mtime_callback

func futimes*(fd: cint; atime: cstring; mtime: cstring; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_futimes_fd_atime_mtime_callback
...
func lchmod*(path: cstring; mode: cint; callback: proc) {.importjs: "fs.$1(#, #, #)".}
...
func lchown*(path: cstring; uid: cint; gid: cint; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
...
func lutimes*(path: cstring; atime: cint; mtime: cint; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_lutimes_path_atime_mtime_callback

func lutimes*(path: cstring; atime: cstring; mtime: cstring; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_lutimes_path_atime_mtime_callback
...
func link*(existingPath: cstring; newPath: cstring; callback: proc) {.importjs: "fs.$1(#, #, #)".}
...
func lstat*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_lstat_path_options_callback

func mkdir*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_mkdir_path_options_callback

func mkdirSync*(path: cstring): cstring {.importjs: "fs.$1(#)".}
  ## https://nodejs.org/api/fs.html#fs_fs_mkdirsync_path_options

func mkdtemp*(prefix: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
...
func open*(path: cstring; flags: cstring; mode: cstring; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_open_path_flags_mode_callback

func open*(path: cstring; flags: cint; mode: cint; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_open_path_flags_mode_callback

func open*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_open_path_flags_mode_callback

func opendir*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
...
func read*(fd: cint; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_read_fd_options_callback

func readdir*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_readdir_path_options_callback

func readFile*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_readfile_path_options_callback

func readFileSync*(path: cstring): cstring {.importjs: "fs.$1(#)".}
  ## https://nodejs.org/api/fs.html#fs_fs_readfilesync_path_options

func readlink*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
...
func realpath*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_realpath_path_options_callback

func realpathNative*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
...
func rename*(oldPath, newPath: cstring; callback: proc) {.importjs: "fs.$1(#, #, #)".}
...
func rmdir*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
...
func rm*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
...
func stat*(path: cstring; callback: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_stat_path_options_callback

func symlink*(target, path, tipe: cstring; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_symlink_target_path_type_callback

func symlink*(target, path: cstring; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_symlink_target_path_type_callback
...
func watch*(filename: cstring; listener: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_watch_filename_options_listener

func unwatchFile*(filename: cstring; listener: proc) {.importjs: "fs.$1(#, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_unwatchfile_filename_listener

func unwatchFile*(filename: cstring) {.importjs: "fs.$1(#)".}
  ## https://nodejs.org/api/fs.html#fs_fs_unwatchfile_filename_listener

func unwatchFile*(fd: cint; stryng: cstring; position: cint; callback: proc) {.importjs: "fs.$1(#, #, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_write_fd_string_position_encoding_callback

func unwatchFile*(fd: cint; stryng: cstring; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_write_fd_string_position_encoding_callback

func writeFile*(fd: cint; data: cstring; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_writefile_file_data_options_callback

func writeFile*(fd: cstring; data: cstring; callback: proc) {.importjs: "fs.$1(#, #, #)".}
  ## https://nodejs.org/api/fs.html#fs_fs_writefile_file_data_options_callback
