...
function auxWriteStackTrace_33556531(f_33556532) {
  ...
  var result_33556533 = [[]];
    ...
    L6: do {
      ...
      colontmp__486539433 = (i_33556542 - 1);
      var res_486539435 = colontmp__486539433;
      L7: do {
          L8: while (true) {
          if (!(0 <= res_486539435)) break L8;
            j_33556590 = res_486539435;
...
function len_503316548(self_503316549) {
  var result_503316550 = 0;

  var F={procname:"jsurl.len",prev:framePtr,filename:"/home/runner/work/nodejs/nodejs/src/nodejs/jsurl.nim",line:0};
  framePtr = F;
    F.line = 64;
    result_503316550 = (cstrToNimstr(self_503316549.toString())).length;
  framePtr = F.prev;

  return result_503316550;
...
function HEX3DHEX3D_486539302(x_486539304, y_486539305) {
  var result_486539306 = false;

  var F={procname:"==.==",prev:framePtr,filename:"/home/runner/.choosenim/toolchains/nim-#devel/lib/system/comparisons.nim",line:0};
  framePtr = F;
  BeforeRet: do {
    F.line = 301;
    var sameObject_486539314 = false;
    F.line = 302;
    sameObject_486539314 = x_486539304 === y_486539305
    if (sameObject_486539314) {
    F.line = 303;
    result_486539306 = true;
    break BeforeRet;
    }
    
    if (!(((x_486539304).length == (y_486539305).length))) {
    F.line = 306;
    result_486539306 = false;
    break BeforeRet;
    }
    ...
    L1: do {
      ...
      var i_486539332 = 0;
      F.line = 126;
      var colontmp__486539440 = ({a: 0, b: 0});
      F.line = 308;
      colontmp__486539440 = nimCopy(colontmp__486539440, HEX2EHEX2E_536872397(0, subInt((x_486539304).length, 1)), NTI536871681);
      L2: do {
        F.line = 129;
        var x_486539446 = 0;
        F.line = 90;
        var res_486539447 = colontmp__486539440.a;
        L3: do {
          F.line = 91;
            L4: while (true) {
            if (!(res_486539447 <= colontmp__486539440.b)) break L4;
              F.line = 129;
              x_486539446 = res_486539447;
              F.line = 308;
              i_486539332 = x_486539446;
              if (!((x_486539304[chckIndx(i_486539332, 0, (x_486539304).length-1)] == y_486539305[chckIndx(i_486539332, 0, (y_486539305).length-1)]))) {
              F.line = 310;
              result_486539306 = false;
              break BeforeRet;
              }
              ...
              F.line = 93;
              res_486539447 = addInt(res_486539447, 1);
            }
        } while(false);
      } while(false);
    } while(false);
  ...
  return result_486539306;

}
function HEX24_486539369(self_486539371) {
  var result_486539372 = [];

  var F={procname:"$.$",prev:framePtr,filename:"/home/runner/work/nodejs/nodejs/src/nodejs/jsurl.nim",line:0};
  framePtr = F;
    F.line = 62;
    result_486539372 = nimCopy(null, cstrToNimstr(self_486539371.toString()), NTI33554439);
  framePtr = F.prev;

  return result_486539372;
...
L1: do {
  F.line = 9;
  var u_486539265 = (new URL("https://user:pass@sub.example.com:8080/p/a/t/h?query=string#hash"));
  if (false) {
  F.line = 10;
  ...
  if (!((len_503316548(u_486539265) == 64))) {
  F.line = 11;
...
L2: do {
  F.line = 14;
  var para_486539283 = (new URLSearchParams("?user=abc&query=xyz"));
  if (false) {
  F.line = 15;
  ...
  F.line = 16;
  para_486539283.append("key", "value");
  F.line = 17;
  para_486539283.sort();
  if (!(para_486539283.has("key"))) {
  F.line = 18;
  ...
  if (!(HEX3DHEX3D_486539302(Array.from(para_486539283.keys()), ["key", "query", "user"]))) {
  F.line = 19;
  ...
  if (!(HEX3DHEX3D_486539302(Array.from(para_486539283.values()), ["value", "xyz", "abc"]))) {
  F.line = 20;
  ...
  if (!((para_486539283.get("key") == "value"))) {
  F.line = 21;
  ...
  if (!(HEX3DHEX3D_486539302(para_486539283.getAll("key"), ["value"]))) {
  F.line = 22;
  ...
  if (!(eqStrings(HEX24_486539369(para_486539283), makeNimstrLit("key=value&query=xyz&user=abc")))) {
  F.line = 23;
