...
framePtr = F;
framePtr = F.prev;
var F = {procname: "module jscore_examples_1", prev: framePtr, filename: "/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jscore_examples_1.nim", line: 0};
framePtr = F;
framePtr = F.prev;
...
function parseBool_587202760(s_587202761) {
      const value = String(s_587202761).trim();
...
F.line = 177;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jscore_examples_1.nim(9, 12) `base64encode(\"Como siempre: lo urgente no deja tiempo para lo importante\".cstring) ==\x0A    \"Q29tbyBzaWVtcHJlOiBsbyB1cmdlbnRlIG5vIGRlamEgdGllbXBvIHBhcmEgbG8gaW1wb3J0YW50ZQ==\".cstring` "));
}
...
F.line = 177;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jscore_examples_1.nim(10, 12) `base64decode(\"Q29tbyBzaWVtcHJlOiBsbyB1cmdlbnRlIG5vIGRlamEgdGllbXBvIHBhcmEgbG8gaW1wb3J0YW50ZQ==\".cstring) ==\x0A    \"Como siempre: lo urgente no deja tiempo para lo importante\".cstring` "));
}

if (!(HEX3DHEX3D_570425364([...new Set(new Int32Array([9, 1, 2, 3, 4, 9, 9, 9, 0]))], [9, 1, 2, 3, 4, 0]))) {
F.line = 177;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jscore_examples_1.nim(11, 12) `deduplicate([9, 1, 2, 3, 4, 9, 9, 9, 0]) == @[9, 1, 2, 3, 4, 0]` "));
}

if (!(HEX3DHEX3D_570425364([...new Set([9, 9, 9, 9])], [9]))) {
F.line = 177;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jscore_examples_1.nim(12, 12) `deduplicate(@[9, 9, 9, 9]) == @[9]` "));
}
  ...
  Label2: do {
    F.line = 34;
      ...
      if (!true) break Label3;
        ...
        if (!(parseBool_587202760(okis_570425450[0]))) {
        F.line = 177;
        failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jscore_examples_1.nim(18, 16) `parseBool(okis)` "));
        }
  ...
  Label6: do {
    F.line = 34;
      ...
      if (!true) break Label7;
        ...
        if (!(!(parseBool_587202760(nope_570425490[0])))) {
        F.line = 177;
        failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jscore_examples_1.nim(26, 5) `not parseBool(nope)` "));
        }
...
F.line = 177;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jscore_examples_1.nim(29, 12) `exampl[0] == \'h\'` "));
}

if (!((toJSStr(HEX5BHEX5D_570425540(exampl_570425496, HEX2EHEX2E_570425502(0, 3))) == "hell"))) {
F.line = 177;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jscore_examples_1.nim(30, 12) `exampl[0 .. 3] == \"hell\".cstring` "));
}

if (!((toJSStr(HEX5BHEX5D_570425591(exampl_570425496, HEX2EHEX2E_570425560(0, 2))) == "hell"))) {
F.line = 177;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jscore_examples_1.nim(31, 12) `exampl[0 .. ^2] == \"hell\".cstring` "));
}
