...
function auxWriteStackTrace_33556547(f_33556548) {
  ...
  var result_33556549 = [[]];
    ...
    Label6: do {
      var j_33556606 = 0;
      var colontmp__520093707 = 0;
      colontmp__520093707 = (i_33556558 - 1);
      var res_520093709 = colontmp__520093707;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_520093709)) break Label8;
            j_33556606 = res_520093709;
...
if (false) {
F.line = 8;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsv8_examples1.nim(8, 10) `cachedDataVersionTag() is cint` "));
}
