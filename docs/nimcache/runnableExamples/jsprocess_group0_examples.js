...
function auxWriteStackTrace_33556556(f_33556557) {
  ...
  var result_33556558 = [[]];
    ...
    Label6: do {
      var j_33556599 = 0;
      var colontmp__553648246 = 0;
      colontmp__553648246 = (i_33556567 - 1);
      var res_553648248 = colontmp__553648246;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_553648248)) break Label8;
            j_33556599 = res_553648248;
...
function addQuoted_553648232(s_553648234, s_553648234_Idx, x_553648235) {
  ...
  framePtr = F;
    F.line = 2922;
    addInt_33557564(s_553648234, s_553648234_Idx, x_553648235);
  framePtr = F.prev;

  
}

function collectionToString_553648199(x_553648201, prefix_553648202, separator_553648203, suffix_553648204) {
  ...
  framePtr = F;
    F.line = 135;
    result_553648205[0] = nimCopy(null, prefix_553648202, NTI33554439);
    F.line = 136;
    var firstElement_553648206 = true;
    Label1: do {
      F.line = 137;
      var value_553648228 = null;
      var value_553648228_Idx = 0;
      F.line = 235;
      var i_553648254 = 0;
      F.line = 236;
      var L_553648255 = (x_553648201).length;
      Label2: do {
        F.line = 237;
          Label3: while (true) {
          if (!(i_553648254 < L_553648255)) break Label3;
            F.line = 137;
            value_553648228 = x_553648201; value_553648228_Idx = i_553648254;
            if (firstElement_553648206) {
            F.line = 139;
            firstElement_553648206 = false;
            }
            else {
              F.line = 141;
            result_553648205[0].push.apply(result_553648205[0], separator_553648203);;
            }
            
            F.line = 150;
            addQuoted_553648232(result_553648205, 0, value_553648228[value_553648228_Idx]);
            F.line = 239;
            i_553648254 += 1;
            if (!(((x_553648201).length == L_553648255))) {
            F.line = 240;
    ...
    F.line = 151;
    result_553648205[0].push.apply(result_553648205[0], suffix_553648204);;
  framePtr = F.prev;

  return result_553648205[0];

}

function HEX24_553648195(x_553648197) {
  var result_553648198 = [];

  var F = {procname: "$.$", prev: framePtr, filename: "/home/runner/.choosenim/toolchains/nim-#devel/lib/system/dollars.nim", line: 0};
  framePtr = F;
    F.line = 162;
    result_553648198 = nimCopy(null, collectionToString_553648199(x_553648197, makeNimstrLit("@["), makeNimstrLit(", "), makeNimstrLit("]")), NTI33554439);
  framePtr = F.prev;

  return result_553648198;
...
F.line = 141;
rawEcho(HEX24_553648195(process.getgroups()));
F.line = 141;
rawEcho(cstrToNimstr((((process.getuid()) | 0)) + ""));
F.line = 141;
rawEcho(HEX24_553648195(process.hrtime()));
F.line = 141;
