...
function auxWriteStackTrace_33556547(f_33556548) {
  ...
  var result_33556549 = [[]];
    ...
    Label6: do {
      ...
      colontmp__520093814 = (i_33556558 - 1);
      var res_520093816 = colontmp__520093814;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_520093816)) break Label8;
            j_33556606 = res_520093816;
...
function addInt_33557573(result_33557574, result_33557574_Idx, x_33557575) {
  var F = {procname: "system.addInt", prev: framePtr, filename: "/home/runner/.choosenim/toolchains/nim-#devel/lib/system.nim", line: 0};
  framePtr = F;
    F.line = 2466;
    result_33557574[result_33557574_Idx].push.apply(result_33557574[result_33557574_Idx], cstrToNimstr((x_33557575) + ""));;
  framePtr = F.prev;

  
}

function addQuoted_520093800(s_520093802, s_520093802_Idx, x_520093803) {
  ...
  framePtr = F;
    F.line = 2919;
    addInt_33557573(s_520093802, s_520093802_Idx, x_520093803);
  framePtr = F.prev;

  
}

function collectionToString_520093767(x_520093769, prefix_520093770, separator_520093771, suffix_520093772) {
  ...
  framePtr = F;
    F.line = 138;
    result_520093773[0] = nimCopy(null, prefix_520093770, NTI33554439);
    F.line = 139;
    var firstElement_520093774 = true;
    Label1: do {
      F.line = 140;
      var value_520093796 = null;
      var value_520093796_Idx = 0;
      F.line = 235;
      var i_520093822 = 0;
      F.line = 236;
      var L_520093823 = (x_520093769).length;
      Label2: do {
        F.line = 237;
          Label3: while (true) {
          if (!(i_520093822 < L_520093823)) break Label3;
            F.line = 140;
            value_520093796 = x_520093769; value_520093796_Idx = i_520093822;
            if (firstElement_520093774) {
            F.line = 142;
            firstElement_520093774 = false;
            }
            else {
              F.line = 144;
            result_520093773[0].push.apply(result_520093773[0], separator_520093771);;
            }
            
            F.line = 153;
            addQuoted_520093800(result_520093773, 0, value_520093796[value_520093796_Idx]);
            F.line = 239;
            i_520093822 += 1;
            if (!(((x_520093769).length == L_520093823))) {
            F.line = 240;
    ...
    F.line = 154;
    result_520093773[0].push.apply(result_520093773[0], suffix_520093772);;
  framePtr = F.prev;

  return result_520093773[0];

}

function HEX24_520093763(x_520093765) {
  var result_520093766 = [];

  var F = {procname: "$.$", prev: framePtr, filename: "/home/runner/.choosenim/toolchains/nim-#devel/lib/system/dollars.nim", line: 0};
  framePtr = F;
    F.line = 165;
    result_520093766 = nimCopy(null, collectionToString_520093767(x_520093765, makeNimstrLit("@["), makeNimstrLit(", "), makeNimstrLit("]")), NTI33554439);
  framePtr = F.prev;
...
F.line = 8;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsprocess_examples1.nim(8, 1) `not hasUncaughtExceptionCaptureCallback()` "));
}
...
F.line = 12;
rawEcho(HEX24_520093763(process.getgroups()));
F.line = 13;
rawEcho(cstrToNimstr((((process.getuid()) | 0)) + ""));
F.line = 14;
rawEcho(HEX24_520093763(process.hrtime()));
F.line = 15;
