...
framePtr = F;
framePtr = F.prev;
var F = {procname: "module jsprocess_examples_1", prev: framePtr, filename: "/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsprocess_examples_1.nim", line: 0};
framePtr = F;
framePtr = F.prev;
...
function auxWriteStackTrace_33556559(f_33556560) {
  ...
  var result_33556561 = [[]];
    ...
    Label6: do {
      var j_33556602 = 0;
      var colontmp__570425462 = 0;
      colontmp__570425462 = (i_33556570 - 1);
      var res_570425464 = colontmp__570425462;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_570425464)) break Label8;
            j_33556602 = res_570425464;
...
function addQuoted_570425448(s_570425450, s_570425450_Idx, x_570425451) {
  ...
  framePtr = F;
    F.line = 2922;
    addInt_33557572(s_570425450, s_570425450_Idx, x_570425451);
  framePtr = F.prev;

  
}

function collectionToString_570425415(x_570425417, prefix_570425418, separator_570425419, suffix_570425420) {
  var result_570425421 = [[]];
  ...
  framePtr = F;
    F.line = 135;
    result_570425421[0] = nimCopy(null, prefix_570425418, NTI33554439);
    F.line = 136;
    var firstElement_570425422 = true;
    Label1: do {
      F.line = 137;
      var value_570425444 = null;
      var value_570425444_Idx = 0;
      F.line = 235;
      var i_570425470 = 0;
      F.line = 236;
      var L_570425471 = (x_570425417).length;
      Label2: do {
        F.line = 237;
          Label3: while (true) {
          if (!(i_570425470 < L_570425471)) break Label3;
            F.line = 137;
            value_570425444 = x_570425417; value_570425444_Idx = i_570425470;
            if (firstElement_570425422) {
            F.line = 139;
            firstElement_570425422 = false;
            }
            else {
              F.line = 141;
            result_570425421[0].push.apply(result_570425421[0], separator_570425419);;
            }
            
            F.line = 150;
            addQuoted_570425448(result_570425421, 0, value_570425444[value_570425444_Idx]);
            F.line = 239;
            i_570425470 += 1;
            if (!(((x_570425417).length == L_570425471))) {
            F.line = 240;
    ...
    F.line = 151;
    result_570425421[0].push.apply(result_570425421[0], suffix_570425420);;
  framePtr = F.prev;

  return result_570425421[0];

}

function HEX24_570425411(x_570425413) {
  ...
  framePtr = F;
    F.line = 162;
    result_570425414 = nimCopy(null, collectionToString_570425415(x_570425413, makeNimstrLit("@["), makeNimstrLit(", "), makeNimstrLit("]")), NTI33554439);
  framePtr = F.prev;
...
F.line = 141;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsprocess_examples_1.nim(9, 3) `not hasUncaughtExceptionCaptureCallback()` "));
}
...
F.line = 141;
rawEcho(HEX24_570425411(process.getgroups()));
F.line = 141;
rawEcho(cstrToNimstr((((process.getuid()) | 0)) + ""));
F.line = 141;
rawEcho(HEX24_570425411(process.hrtime()));
F.line = 141;
