...
function auxWriteStackTrace_33556531(f_33556532) {
  ...
  var result_33556533 = [[]];
    ...
    L6: do {
      var j_33556590 = 0;
      var colontmp__486539381 = 0;
      colontmp__486539381 = (i_33556542 - 1);
      var res_486539383 = colontmp__486539381;
      L7: do {
          L8: while (true) {
          if (!(0 <= res_486539383)) break L8;
            j_33556590 = res_486539383;
...
function addQuoted_486539367(s_486539369, s_486539369_Idx, x_486539370) {
  ...
  framePtr = F;
    F.line = 2924;
    addInt_33557572(s_486539369, s_486539369_Idx, x_486539370);
  framePtr = F.prev;

  
}
function collectionToString_486539334(x_486539336, prefix_486539337, separator_486539338, suffix_486539339) {
  var result_486539340 = [[]];
  ...
  framePtr = F;
    F.line = 148;
    result_486539340[0] = nimCopy(null, prefix_486539337, NTI33554439);
    F.line = 149;
    var firstElement_486539341 = true;
    L1: do {
      F.line = 150;
      var value_486539363 = null;
      var value_486539363_Idx = 0;
      F.line = 235;
      var i_486539389 = 0;
      F.line = 236;
      var L_486539390 = (x_486539336).length;
      L2: do {
        F.line = 237;
          L3: while (true) {
          if (!(i_486539389 < L_486539390)) break L3;
            F.line = 150;
            value_486539363 = x_486539336; value_486539363_Idx = i_486539389;
            if (firstElement_486539341) {
            F.line = 152;
            firstElement_486539341 = false;
            }
            else {
              F.line = 154;
            result_486539340[0].push.apply(result_486539340[0], separator_486539338);;
            }
            
            F.line = 163;
            addQuoted_486539367(result_486539340, 0, value_486539363[value_486539363_Idx]);
            F.line = 239;
            i_486539389 += 1;
            if (!(((x_486539336).length == L_486539390))) {
            F.line = 240;
    ...
    F.line = 164;
    result_486539340[0].push.apply(result_486539340[0], suffix_486539339);;
  framePtr = F.prev;

  return result_486539340[0];

}
function HEX24_486539330(x_486539332) {
  var result_486539333 = [];

  var F={procname:"$.$",prev:framePtr,filename:"/home/runner/.choosenim/toolchains/nim-#devel/lib/system/dollars.nim",line:0};
  framePtr = F;
    F.line = 175;
    result_486539333 = nimCopy(null, collectionToString_486539334(x_486539332, makeNimstrLit("@["), makeNimstrLit(", "), makeNimstrLit("]")), NTI33554439);
  framePtr = F.prev;

  return result_486539333;
...
F.line = 12;
rawEcho(HEX24_486539330(process.getgroups()));
F.line = 13;
rawEcho(cstrToNimstr((((process.getuid())|0))+""));
F.line = 14;
rawEcho(HEX24_486539330(process.hrtime()));
F.line = 15;
