...
function auxWriteStackTrace_33556531(f_33556532) {
  ...
  var result_33556533 = [[]];
    ...
    L6: do {
      var j_33556590 = 0;
      var colontmp__486539335 = 0;
      colontmp__486539335 = (i_33556542 - 1);
      var res_486539337 = colontmp__486539335;
      L7: do {
          L8: while (true) {
          if (!(0 <= res_486539337)) break L8;
            j_33556590 = res_486539337;
...
L1: do {
  F.line = 10;
  var tracker_486539265 = (new assert.CallTracker());
  if (false) {
  F.line = 11;
...
L2: do {
  ...
  F.line = 20;
  var rege_486539311 = new RegExp("[0-9]", "i");
  F.line = 21;
  assert.doesNotMatch("abcde", rege_486539311, "message");
} while(false);
framePtr = F.prev;
var F={procname:"module jsassert_examples1",prev:framePtr,filename:"/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples1.nim",line:0};
framePtr = F;
