...
function auxWriteStackTrace_33556530(f_33556531) {
  ...
  var result_33556532 = [[]];
    ...
    Label6: do {
      var j_33556589 = 0;
      var colontmp__503316542 = 0;
      colontmp__503316542 = (i_33556541 - 1);
      var res_503316544 = colontmp__503316542;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_503316544)) break Label8;
            j_33556589 = res_503316544;
...
Label1: do {
  F.line = 10;
  var tracker_503316481 = (new assert.CallTracker());
  if (false) {
  F.line = 11;
  failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples1.nim(11, 12) `tracker.report() is JsObject` "));
  }
  
  F.line = 12;
  tracker_503316481.verify();
} while (false);
Label2: do {
  if (!((JSON.stringify(new assert.AssertionError({})) == "{\"generatedMessage\":true,\"code\":\"ERR_ASSERTION\"}"))) {
  F.line = 14;
  failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples1.nim(14, 12) `newAssertionError() ==\x0A    \"\"\"{\"generatedMessage\":true,\"code\":\"ERR_ASSERTION\"}\"\"\".cstring` "));
  }
  ...
  F.line = 15;
  failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples1.nim(15, 12) `newAssertionError(\"message\".cstring, 1.cint, 2.cint, \"strictEqual\".cstring) ==\x0A    \"\"\"{\"generatedMessage\":false,\"code\":\"ERR_ASSERTION\",\"actual\":1,\"expected\":2,\"operator\":\"strictEqual\"}\"\"\".cstring` "));
  }
  ...
  F.line = 20;
  var rege_503316527 = new RegExp("[0-9]", "i");
  F.line = 21;
  assert.doesNotMatch("abcde", rege_503316527, "message");
} while (false);
framePtr = F.prev;
var F = {procname: "module jsassert_examples1", prev: framePtr, filename: "/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples1.nim", line: 0};
framePtr = F;
