...
function auxWriteStackTrace_33556556(f_33556557) {
  ...
  var result_33556558 = [[]];
    ...
    Label6: do {
      var j_33556599 = 0;
      var colontmp__553648193 = 0;
      colontmp__553648193 = (i_33556567 - 1);
      var res_553648195 = colontmp__553648193;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_553648195)) break Label8;
            j_33556599 = res_553648195;
...
Label1: do {
  F.line = 132;
  var tracker_553648132 = (new assert.CallTracker());
  if (false) {
  F.line = 132;
...
Label2: do {
  ...
  F.line = 132;
  var rege_553648178 = new RegExp("[0-9]", "i");
  F.line = 132;
  assert.doesNotMatch("abcde", rege_553648178, "message");
} while (false);
framePtr = F.prev;
var F = {procname: "module jsassert_examples_1", prev: framePtr, filename: "/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples_1.nim", line: 0};
framePtr = F;
