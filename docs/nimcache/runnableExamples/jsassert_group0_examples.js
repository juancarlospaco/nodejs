...
framePtr = F;
framePtr = F.prev;
var F = {procname: "module jsassert_examples_1", prev: framePtr, filename: "/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples_1.nim", line: 0};
framePtr = F;
framePtr = F.prev;
...
function auxWriteStackTrace_33556559(f_33556560) {
  ...
  var result_33556561 = [[]];
    ...
    Label6: do {
      var j_33556602 = 0;
      var colontmp__570425409 = 0;
      colontmp__570425409 = (i_33556570 - 1);
      var res_570425411 = colontmp__570425409;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_570425411)) break Label8;
            j_33556602 = res_570425411;
...
Label1: do {
  F.line = 132;
  var tracker_570425348 = (new assert.CallTracker());
  if (false) {
  F.line = 132;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples_1.nim(12, 14) `tracker.report() is JsObject` "));
  }
  
  F.line = 132;
  tracker_570425348.verify();
} while (false);
Label2: do {
  if (!((JSON.stringify(new assert.AssertionError({})) == "{\"generatedMessage\":true,\"code\":\"ERR_ASSERTION\"}"))) {
  F.line = 132;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples_1.nim(15, 14) `newAssertionError() ==\x0A    \"\"\"{\"generatedMessage\":true,\"code\":\"ERR_ASSERTION\"}\"\"\".cstring` "));
  }
  ...
  F.line = 132;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples_1.nim(16, 14) `newAssertionError(\"message\".cstring, 1.cint, 2.cint, \"strictEqual\".cstring) ==\x0A    \"\"\"{\"generatedMessage\":false,\"code\":\"ERR_ASSERTION\",\"actual\":1,\"expected\":2,\"operator\":\"strictEqual\"}\"\"\".cstring` "));
  }
  ...
  F.line = 132;
  var rege_570425394 = new RegExp("[0-9]", "i");
  F.line = 132;
  assert.doesNotMatch("abcde", rege_570425394, "message");
} while (false);
framePtr = F.prev;
var F = {procname: "module jsassert_examples_1", prev: framePtr, filename: "/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsassert_examples_1.nim", line: 0};
framePtr = F;
