...
function addQuoted_486539302(s_486539304, s_486539304_Idx, x_486539305) {
  ...
  framePtr = F;
    F.line = 2924;
    addInt_33557572(s_486539304, s_486539304_Idx, x_486539305);
  framePtr = F.prev;
...
function collectionToString_486539269(x_486539271, prefix_486539272, separator_486539273, suffix_486539274) {
  var result_486539275 = [[]];
  ...
  framePtr = F;
    F.line = 148;
    result_486539275[0] = nimCopy(null, prefix_486539272, NTI33554439);
    F.line = 149;
    var firstElement_486539276 = true;
    L1: do {
      F.line = 150;
      var value_486539298 = null;
      var value_486539298_Idx = 0;
      F.line = 235;
      var i_486539329 = 0;
      F.line = 236;
      var L_486539330 = (x_486539271).length;
      L2: do {
        F.line = 237;
          L3: while (true) {
          if (!(i_486539329 < L_486539330)) break L3;
            F.line = 150;
            value_486539298 = x_486539271; value_486539298_Idx = i_486539329;
            if (firstElement_486539276) {
            F.line = 152;
            firstElement_486539276 = false;
            }
            else {
              F.line = 154;
            result_486539275[0].push.apply(result_486539275[0], separator_486539273);;
            }
            
            F.line = 163;
            addQuoted_486539302(result_486539275, 0, value_486539298[value_486539298_Idx]);
            F.line = 239;
            i_486539329 += 1;
            if (!(((x_486539271).length == L_486539330))) {
            F.line = 240;
    ...
    F.line = 164;
    result_486539275[0].push.apply(result_486539275[0], suffix_486539274);;
  framePtr = F.prev;

  return result_486539275[0];

}
function HEX24_486539265(x_486539267) {
  var result_486539268 = [];

  var F={procname:"$.$",prev:framePtr,filename:"/home/runner/.choosenim/toolchains/nim-#devel/lib/system/dollars.nim",line:0};
  framePtr = F;
    F.line = 175;
    result_486539268 = nimCopy(null, collectionToString_486539269(x_486539267, makeNimstrLit("@["), makeNimstrLit(", "), makeNimstrLit("]")), NTI33554439);
  framePtr = F.prev;
...
F.line = 13;
rawEcho(HEX24_486539265(os.loadavg()));
F.line = 14;
