...
framePtr = F;
framePtr = F.prev;
var F = {procname: "module jsos_examples1", prev: framePtr, filename: "/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsos_examples1.nim", line: 0};
framePtr = F;
framePtr = F.prev;
...
function addQuoted_503316518(s_503316520, s_503316520_Idx, x_503316521) {
  ...
  framePtr = F;
    F.line = 2909;
    addInt_33557571(s_503316520, s_503316520_Idx, x_503316521);
  framePtr = F.prev;
...
function auxWriteStackTrace_33556530(f_33556531) {
  ...
  var result_33556532 = [[]];
    ...
    Label6: do {
      ...
      colontmp__503316551 = (i_33556541 - 1);
      var res_503316553 = colontmp__503316551;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_503316553)) break Label8;
            j_33556589 = res_503316553;
...
function collectionToString_503316485(x_503316487, prefix_503316488, separator_503316489, suffix_503316490) {
  ...
  framePtr = F;
    F.line = 148;
    result_503316491[0] = nimCopy(null, prefix_503316488, NTI33554439);
    F.line = 149;
    var firstElement_503316492 = true;
    Label1: do {
      F.line = 150;
      var value_503316514 = null;
      var value_503316514_Idx = 0;
      F.line = 235;
      var i_503316545 = 0;
      F.line = 236;
      var L_503316546 = (x_503316487).length;
      Label2: do {
        F.line = 237;
          Label3: while (true) {
          if (!(i_503316545 < L_503316546)) break Label3;
            F.line = 150;
            value_503316514 = x_503316487; value_503316514_Idx = i_503316545;
            if (firstElement_503316492) {
            F.line = 152;
            firstElement_503316492 = false;
            }
            else {
              F.line = 154;
            result_503316491[0].push.apply(result_503316491[0], separator_503316489);;
            }
            
            F.line = 163;
            addQuoted_503316518(result_503316491, 0, value_503316514[value_503316514_Idx]);
            F.line = 239;
            i_503316545 += 1;
            if (!(((x_503316487).length == L_503316546))) {
            F.line = 240;
    ...
    F.line = 164;
    result_503316491[0].push.apply(result_503316491[0], suffix_503316490);;
  framePtr = F.prev;

  return result_503316491[0];

}

function HEX24_503316481(x_503316483) {
  var result_503316484 = [];

  var F = {procname: "$.$", prev: framePtr, filename: "/home/runner/.choosenim/toolchains/nim-#devel/lib/system/dollars.nim", line: 0};
  framePtr = F;
    F.line = 175;
    result_503316484 = nimCopy(null, collectionToString_503316485(x_503316483, makeNimstrLit("@["), makeNimstrLit(", "), makeNimstrLit("]")), NTI33554439);
  framePtr = F.prev;

  return result_503316484;
...
F.line = 13;
rawEcho(HEX24_503316481(os.loadavg()));
F.line = 14;
