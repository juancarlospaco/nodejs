...
function auxWriteStackTrace_33556547(f_33556548) {
  ...
  var result_33556549 = [[]];
    ...
    Label6: do {
      var j_33556606 = 0;
      var colontmp__520093758 = 0;
      colontmp__520093758 = (i_33556558 - 1);
      var res_520093760 = colontmp__520093758;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_520093760)) break Label8;
            j_33556606 = res_520093760;
...
F.line = 9;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(9, 10) `basename(\"/foo/bar/baz\".cstring) == \"baz\".cstring` "));
}

if (!((path.dirname("/foo/bar/baz/file.ext") == "/foo/bar/baz"))) {
F.line = 10;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(10, 10) `dirname(\"/foo/bar/baz/file.ext\".cstring) == \"/foo/bar/baz\".cstring` "));
}

if (!((path.extname("/foo/bar/baz/file.ext") == ".ext"))) {
F.line = 11;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(11, 10) `extname(\"/foo/bar/baz/file.ext\".cstring) == \".ext\".cstring` "));
}

if (!(path.isAbsolute("/foo/bar/baz/file.ext"))) {
F.line = 12;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(12, 10) `isAbsolute(\"/foo/bar/baz/file.ext\".cstring)` "));
}

if (!((path.normalize("/foo/bar/baz/file.ext") == "/foo/bar/baz/file.ext"))) {
F.line = 13;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(13, 10) `normalize(\"/foo/bar/baz/file.ext\".cstring) == \"/foo/bar/baz/file.ext\".cstring` "));
}

if (!((path.normalize("/foo/bar/baz/file.ext") == "/foo/bar/baz/file.ext"))) {
F.line = 14;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(14, 10) `normalize(\"/foo/bar/baz/file.ext\".cstring) == \"/foo/bar/baz/file.ext\".cstring` "));
}

if (!((path.relative("/foo/bar/baz/file.ext", "/x/") == "../../../../x"))) {
F.line = 15;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(15, 10) `relative(\"/foo/bar/baz/file.ext\".cstring, \"/x/\".cstring) ==\x0A    \"../../../../x\".cstring` "));
}

if (!((path.resolve("/foo/bar/baz/file.ext") == "/foo/bar/baz/file.ext"))) {
F.line = 16;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(16, 10) `resolve(\"/foo/bar/baz/file.ext\".cstring) == \"/foo/bar/baz/file.ext\".cstring` "));
}

if (!((path.toNamespacedPath("/foo/bar/baz/file.ext") == "/foo/bar/baz/file.ext"))) {
F.line = 17;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(17, 10) `toNamespacedPath(\"/foo/bar/baz/file.ext\".cstring) ==\x0A    \"/foo/bar/baz/file.ext\".cstring` "));
}

if (!((path.join("foo", "bar", "file.ext") == "foo/bar/file.ext"))) {
F.line = 18;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(18, 10) `join(\"foo\".cstring, \"bar\".cstring, \"file.ext\".cstring) ==\x0A    \"foo/bar/file.ext\".cstring` "));
}

if (!((path.join("folder", "file.ext") == "folder/file.ext"))) {
F.line = 19;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples1.nim(19, 10) `\"folder\".cstring / \"file.ext\".cstring == \"folder/file.ext\".cstring` "));
}
