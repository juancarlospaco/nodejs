...
framePtr = F;
framePtr = F.prev;
var F = {procname: "module jspath_examples_1", prev: framePtr, filename: "/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim", line: 0};
framePtr = F;
framePtr = F.prev;
...
function auxWriteStackTrace_33556559(f_33556560) {
  ...
  var result_33556561 = [[]];
    ...
    Label6: do {
      var j_33556602 = 0;
      var colontmp__570425406 = 0;
      colontmp__570425406 = (i_33556570 - 1);
      var res_570425408 = colontmp__570425406;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_570425408)) break Label8;
            j_33556602 = res_570425408;
...
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(10, 12) `basename(\"/foo/bar/baz\".cstring) == \"baz\".cstring` "));
}

if (!((path.dirname("/foo/bar/baz/file.ext") == "/foo/bar/baz"))) {
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(11, 12) `dirname(\"/foo/bar/baz/file.ext\".cstring) == \"/foo/bar/baz\".cstring` "));
}

if (!((path.extname("/foo/bar/baz/file.ext") == ".ext"))) {
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(12, 12) `extname(\"/foo/bar/baz/file.ext\".cstring) == \".ext\".cstring` "));
}

if (!(path.isAbsolute("/foo/bar/baz/file.ext"))) {
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(13, 12) `isAbsolute(\"/foo/bar/baz/file.ext\".cstring)` "));
}

if (!((path.normalize("/foo/bar/baz/file.ext") == "/foo/bar/baz/file.ext"))) {
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(14, 12) `normalize(\"/foo/bar/baz/file.ext\".cstring) == \"/foo/bar/baz/file.ext\".cstring` "));
}

if (!((path.normalize("/foo/bar/baz/file.ext") == "/foo/bar/baz/file.ext"))) {
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(15, 12) `normalize(\"/foo/bar/baz/file.ext\".cstring) == \"/foo/bar/baz/file.ext\".cstring` "));
}

if (!((path.relative("/foo/bar/baz/file.ext", "/x/") == "../../../../x"))) {
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(16, 12) `relative(\"/foo/bar/baz/file.ext\".cstring, \"/x/\".cstring) ==\x0A    \"../../../../x\".cstring` "));
}

if (!((path.resolve("/foo/bar/baz/file.ext") == "/foo/bar/baz/file.ext"))) {
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(17, 12) `resolve(\"/foo/bar/baz/file.ext\".cstring) == \"/foo/bar/baz/file.ext\".cstring` "));
}

if (!((path.toNamespacedPath("/foo/bar/baz/file.ext") == "/foo/bar/baz/file.ext"))) {
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(18, 12) `toNamespacedPath(\"/foo/bar/baz/file.ext\".cstring) ==\x0A    \"/foo/bar/baz/file.ext\".cstring` "));
}

if (!((path.join("foo", "bar", "file.ext") == "foo/bar/file.ext"))) {
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(19, 12) `join(\"foo\".cstring, \"bar\".cstring, \"file.ext\".cstring) ==\x0A    \"foo/bar/file.ext\".cstring` "));
}

if (!((path.join("folder", "file.ext") == "folder/file.ext"))) {
F.line = 56;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspath_examples_1.nim(20, 12) `\"folder\".cstring / \"file.ext\".cstring == \"folder/file.ext\".cstring` "));
}
