...
function auxWriteStackTrace_33556559(f_33556560) {
  ...
  var result_33556561 = [[]];
    ...
    Label6: do {
      var j_33556602 = 0;
      var colontmp__570425389 = 0;
      colontmp__570425389 = (i_33556570 - 1);
      var res_570425391 = colontmp__570425389;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_570425391)) break Label8;
            j_33556602 = res_570425391;
...
Label2: do {
  F.line = 64;
  var rl_570425368 = readline.createInterface({input: process.stdin, output: process.stdout});
  F.line = 64;
  rl_570425368.setPrompt(">>>");
  if (false) {
  F.line = 64;
