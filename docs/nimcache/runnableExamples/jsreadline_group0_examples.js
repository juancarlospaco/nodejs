...
function auxWriteStackTrace_33556531(f_33556532) {
  ...
  var result_33556533 = [[]];
    ...
    L6: do {
      ...
      colontmp__486539306 = (i_33556542 - 1);
      var res_486539308 = colontmp__486539306;
      L7: do {
          L8: while (true) {
          if (!(0 <= res_486539308)) break L8;
            j_33556590 = res_486539308;
...
L2: do {
  F.line = 16;
  var rl_486539285 = readline.createInterface({input: process.stdin, output: process.stdout});
  F.line = 17;
  rl_486539285.setPrompt(">>>");
  if (false) {
  F.line = 19;
