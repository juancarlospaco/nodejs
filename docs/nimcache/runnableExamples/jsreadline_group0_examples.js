...
framePtr = F;
framePtr = F.prev;
var F = {procname: "module jsreadline_examples_1", prev: framePtr, filename: "/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples_1.nim", line: 0};
framePtr = F;
framePtr = F.prev;
...
function auxWriteStackTrace_33556556(f_33556557) {
  ...
  var result_33556558 = [[]];
    ...
    Label6: do {
      var j_33556599 = 0;
      var colontmp__553648173 = 0;
      colontmp__553648173 = (i_33556567 - 1);
      var res_553648175 = colontmp__553648173;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_553648175)) break Label8;
            j_33556599 = res_553648175;
...
Label1: do {
  ...
  F.line = 64;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples_1.nim(12, 14) `clearLine()` "));
  }
  
  if (!(readline.clearScreenDown(process.stout))) {
  F.line = 64;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples_1.nim(13, 14) `clearScreenDown()` "));
  }
  
  if (!(readline.cursorTo(process.stout, 0, 0))) {
  F.line = 64;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples_1.nim(14, 14) `cursorTo(x = 0.cint, y = 0.cint)` "));
  }
  
  if (!(readline.moveCursor(process.stout, 0, 0))) {
  F.line = 64;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples_1.nim(15, 14) `moveCursor(dx = 0.cint, dy = 0.cint)` "));
  }
  
} while (false);
Label2: do {
  F.line = 64;
  var rl_553648152 = readline.createInterface({input: process.stdin, output: process.stdout});
  F.line = 64;
  rl_553648152.setPrompt(">>>");
  if (false) {
  F.line = 64;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples_1.nim(20, 14) `rl.getCursorPos() is JsObject` "));
  }
