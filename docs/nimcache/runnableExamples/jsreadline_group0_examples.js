...
Label1: do {
  ...
  F.line = 11;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples1.nim(11, 12) `clearLine()` "));
  }
  
  if (!(readline.clearScreenDown(process.stout))) {
  F.line = 12;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples1.nim(12, 12) `clearScreenDown()` "));
  }
  
  if (!(readline.cursorTo(process.stout, 0, 0))) {
  F.line = 13;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples1.nim(13, 12) `cursorTo(x = 0.cint, y = 0.cint)` "));
  }
  
  if (!(readline.moveCursor(process.stout, 0, 0))) {
  F.line = 14;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples1.nim(14, 12) `moveCursor(dx = 0.cint, dy = 0.cint)` "));
  }
  
} while (false);
Label2: do {
  F.line = 16;
  var rl_520093720 = readline.createInterface({input: process.stdin, output: process.stdout});
  F.line = 17;
  rl_520093720.setPrompt(">>>");
  if (false) {
  F.line = 19;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jsreadline_examples1.nim(19, 12) `rl.getCursorPos() is JsObject` "));
  }
