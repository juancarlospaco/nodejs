...
function auxWriteStackTrace_33556556(f_33556557) {
  ...
  var result_33556558 = [[]];
    ...
    Label6: do {
      ...
      colontmp__553648226 = (i_33556567 - 1);
      var res_553648228 = colontmp__553648226;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_553648228)) break Label8;
            j_33556599 = res_553648228;
...
function HEX3DHEX3D_553648155(x_553648157, y_553648158) {
  var result_553648159 = false;

  var F = {procname: "==.==", prev: framePtr, filename: "/home/runner/.choosenim/toolchains/nim-#devel/lib/system/comparisons.nim", line: 0};
  framePtr = F;
  BeforeRet: do {
    F.line = 301;
    var sameObject_553648167 = false;
    F.line = 302;
    sameObject_553648167 = x_553648157 === y_553648158
    if (sameObject_553648167) {
    F.line = 303;
    result_553648159 = true;
    break BeforeRet;
    }
    
    if (!(((x_553648157).length == (y_553648158).length))) {
    F.line = 306;
    result_553648159 = false;
    break BeforeRet;
    }
    ...
    Label1: do {
      ...
      F.line = 308;
      colontmp__553648233 = subInt((x_553648157).length, 1);
      F.line = 90;
      var res_553648235 = 0;
      Label2: do {
        F.line = 91;
          Label3: while (true) {
          if (!(res_553648235 <= colontmp__553648233)) break Label3;
            F.line = 308;
            i_553648181 = res_553648235;
            if (!((x_553648157[chckIndx(i_553648181, 0, (x_553648157).length - 1)] == y_553648158[chckIndx(i_553648181, 0, (y_553648158).length - 1)]))) {
            F.line = 310;
            result_553648159 = false;
            break BeforeRet;
            }
            ...
            F.line = 93;
            res_553648235 = addInt(res_553648235, 1);
          }
      } while (false);
    } while (false);
    F.line = 312;
...
if (!(HEX3DHEX3D_553648155(punycode.ucs2.decode("hello"), [104, 101, 108, 108, 111]))) {
F.line = 27;
