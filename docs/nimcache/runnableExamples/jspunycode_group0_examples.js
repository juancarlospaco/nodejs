...
var NTI520093729 = {size: 0,kind: 31,base: null,node: null,finalizer: null};
...
var NNI520093738 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "a", len: 0, typ: NTI520093729, name: "a", sons: null}, 
...
function auxWriteStackTrace_33556547(f_33556548) {
  ...
  var result_33556549 = [[]];
    ...
    Label6: do {
      ...
      colontmp__520093826 = (i_33556558 - 1);
      var res_520093828 = colontmp__520093826;
      Label7: do {
          Label8: while (true) {
          if (!(0 <= res_520093828)) break Label8;
            j_33556606 = res_520093828;
...
function HEX2EHEX2E_520093745(a_520093748, b_520093749) {
  var result_520093752 = ({a: 0, b: 0});

  var F = {procname: ".....", prev: framePtr, filename: "/home/runner/.choosenim/toolchains/nim-#devel/lib/system.nim", line: 0};
  framePtr = F;
    F.line = 507;
    result_520093752 = nimCopy(result_520093752, {a: a_520093748, b: b_520093749}, NTI520093738);
  framePtr = F.prev;
...
function HEX3DHEX3D_520093723(x_520093725, y_520093726) {
  var result_520093727 = false;

  var F = {procname: "==.==", prev: framePtr, filename: "/home/runner/.choosenim/toolchains/nim-#devel/lib/system/comparisons.nim", line: 0};
  framePtr = F;
  BeforeRet: do {
    F.line = 301;
    var sameObject_520093735 = false;
    F.line = 302;
    sameObject_520093735 = x_520093725 === y_520093726
    if (sameObject_520093735) {
    F.line = 303;
    result_520093727 = true;
    break BeforeRet;
    }
    
    if (!(((x_520093725).length == (y_520093726).length))) {
    F.line = 306;
    result_520093727 = false;
    break BeforeRet;
    }
    ...
    Label1: do {
      ...
      var i_520093781 = 0;
      F.line = 126;
      var colontmp__520093833 = ({a: 0, b: 0});
      F.line = 308;
      colontmp__520093833 = nimCopy(colontmp__520093833, HEX2EHEX2E_520093745(0, subInt((x_520093725).length, 1)), NTI520093738);
      Label2: do {
        F.line = 129;
        var x_520093839 = 0;
        F.line = 90;
        var res_520093840 = colontmp__520093833.a;
        Label3: do {
          F.line = 91;
            Label4: while (true) {
            if (!(res_520093840 <= colontmp__520093833.b)) break Label4;
              F.line = 129;
              x_520093839 = res_520093840;
              F.line = 308;
              i_520093781 = x_520093839;
              if (!((x_520093725[chckIndx(i_520093781, 0, (x_520093725).length - 1)] == y_520093726[chckIndx(i_520093781, 0, (y_520093726).length - 1)]))) {
              F.line = 310;
              result_520093727 = false;
              break BeforeRet;
              }
              ...
              F.line = 93;
              res_520093840 = addInt(res_520093840, 1);
            }
        } while (false);
      } while (false);
    } while (false);
...
F.line = 9;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspunycode_examples1.nim(9, 10) `decode(str) == \"\xE3\x97\x81\xE3\x96\xBC\xE3\x96\xB6\".cstring` "));
}

if (!((punycode.encode("hello") == "hello-"))) {
F.line = 10;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspunycode_examples1.nim(10, 10) `encode(str) == \"hello-\".cstring` "));
}

if (!((punycode.toASCII("hello") == "hello"))) {
F.line = 11;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspunycode_examples1.nim(11, 10) `toASCII(str) == \"hello\".cstring` "));
}

if (!((punycode.toUnicode("hello") == "hello"))) {
F.line = 12;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspunycode_examples1.nim(12, 10) `toUnicode(str) == \"hello\".cstring` "));
}

if (!(HEX3DHEX3D_520093723(punycode.ucs2.decode("hello"), [104, 101, 108, 108, 111]))) {
F.line = 13;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspunycode_examples1.nim(13, 10) `ucs2Decode(str) == @[104.cint, 101, 108, 108, 111]` "));
}

if (!((punycode.ucs2.encode([104, 101, 108, 108, 111]) == "hello"))) {
F.line = 14;
failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/nodejs/nodejs/docs/nimcache/runnableExamples/jspunycode_examples1.nim(14, 10) `ucs2Encode(@[104.cint, 101, 108, 108, 111]) == \"hello\".cstring` "));
}
